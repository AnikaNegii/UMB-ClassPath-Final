...
export default function NavigatePage({ params }: Props) {
  ...
  return (
    // flex-col fills the full height — map takes all space above the instruction card
      ...
      {arrived ? (
        ...
        <>
          ...
          >
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="mt-2.5 space-y-2">
                  ...
                  {/* Progress bar — gives a clear visual sense of how far along the route is */}
                  <div
            ...
            {/* Exit Navigation — neutral, not destructive; stopping navigation is not an error */}
            <button
              onClick={() => router.back()}
              className={cn(
